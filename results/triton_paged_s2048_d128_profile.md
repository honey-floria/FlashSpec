...
- latency_ms: `0.332114`
- latency_p50_ms: `0.332114`
- latency_p90_ms: `0.415521`
- latency_p99_ms: `0.416155`
- tokens_per_second: `48176.2`
...
|---|---:|---:|---|---|
| kv_load | 2.69238e+08 | 0 | ncu dram/source-line metrics | 读取 K/V；Triton quant backend 应主要读取 INT8 values 和 scale/zero_point。 |
...
| total_kernel_or_backend | 2.69501e+08 | 1.07689e+09 | cuda_event | 总耗时来自 benchmark 测量；阶段 latency 需要 Nsight Compute 进一步归因。 |

## Measured Profiler Fields

- measured_kernel_latency_ms: `0.332114`
- measured_dram_bytes: `1.40826e+09`
- measured_achieved_bandwidth_gbps: `681.441`
- measured_occupancy_pct: `25.6559`
- measured_sm_utilization_pct: `41.402`
